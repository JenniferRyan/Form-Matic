...
class ChromiumTestCase(unittest.TestCase):
    ...
    def test_ide(self):
        ...
        driver.find_element_by_id("name").send_keys("Joe Bloggs")
        driver.find_element_by_id("email").clear()
        driver.find_element_by_id("email").send_keys("joebloggs@gmail.com")
        driver.find_element_by_id("phone").clear()
        driver.find_element_by_id("phone").send_keys("0862222111")
        driver.find_element_by_id("website").clear()
        driver.find_element_by_id("website").send_keys("http://joe.com")
        ...
        driver.find_element_by_id("confirm_passwd").send_keys("1425675")
